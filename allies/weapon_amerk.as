...
class weapon_amerk : ScriptBasePlayerWeaponEntity
{
	...
	void Precache()
	{
		...
		g_Game.PrecacheGeneric( "sprites/" + "ww2projekt/weapon_amerk.spr" );
	...
	void Holster( int skiplocal /* = 0 */ )
	{
		...
		self.m_pPlayer.pev.viewmodel = "models/ww2projekt/amerk/v_amerk.mdl";
	}
