...
class weapon_webley : ScriptBasePlayerWeaponEntity
{
	...
	void PrimaryAttack()
	{
		...
		g_SoundSystem.EmitSoundDyn( self.m_pPlayer.edict(), CHAN_WEAPON, "weapons/ww2projekt/webley_shoot1.wav", 1.0, ATTN_NORM, 0, PITCH_NORM );
